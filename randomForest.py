...
X = df_rf.drop('Outcome', axis=1)# YOUR CODE HERE
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=0)# YOUR CODE HERE
...
rf_clf = RandomForestClassifier(criterion='gini', max_depth=15, min_samples_leaf=1, min_samples_split=10, max_features='sqrt', random_state=1)# YOUR CODE HERE
